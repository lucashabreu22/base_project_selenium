...
public class EvidenceManager {
    ...
    public static void EvidenceGenerate(String nome) throws IOException {
    ...
    public static void generateDoc() {
        ...
        try {
            ...
            System.out.println("Evidence document was successfully generated!!!");
        } catch (Exception e) {
            System.out.println("There was an error while generating the evidence document!!!");
        } finally {
            try {
